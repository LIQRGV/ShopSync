...
import { CellEditManager } from '../managers/CellEditManager.js';
...
export class ProductSyncGrid {
    ...
    async initializeGrid() {
        ...
        const gridOptions = {
            ...
            onGridReady: (params) => {
                ...
                // Initialize Cell Edit Manager with dependency injection
                this.cellEditManager = new CellEditManager({
     ...
     * Delegates to CellEditManager
     */
    async handleCellEdit(event) {
        if (this.cellEditManager) {
            return this.cellEditManager.handleCellEdit(event);
        }
    }
    ...
    handleEnhancedCellClick(event) {
        if (this.cellEditManager) {
            return this.cellEditManager.handleEnhancedCellClick(event);
        }
    }
